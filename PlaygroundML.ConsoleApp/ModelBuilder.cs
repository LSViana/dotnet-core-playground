...
namespace PlaygroundML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Lucas Viana\Development\csharp\dotnet-core-playground\MachineLearning\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../PlaygroundML.Model/MLModel.zip";
